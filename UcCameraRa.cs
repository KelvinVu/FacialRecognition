...
{
    public partial class UcCameraRa : UserControl
    {
        ...
        private void ShowInfo(string id)
        {
            ...
            string sql1 = "update ChamCong set MaNV='" + txtID.Text + "',GioRa='" + DateTime.Now.TimeOfDay + "'where Ngay='" + DateTime.Now + "' and GioVao= (select max(GioVao) from ChamCong) ";
